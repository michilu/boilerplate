...
var _regex_Client_Id = regexp.MustCompile(`^([a-fA-F0-9]{8}-[a-fA-F0-9]{4}-[4][a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12})?$`)

func (this *Client) Validate() error {
	if !_regex_Client_Id.MatchString(this.Id) {
	...
	if this.Debug != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.Debug); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("Debug", err)
		}
	}
	return nil
}
func (this *Debug) Validate() error {
	if !(this.Port < 65536) {
